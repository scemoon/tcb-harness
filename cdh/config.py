...
class ObservabilityConfig:
    ...
    trace_dir: str = "~/.cloud-dev-harness/traces"
...
class GlobalConfig:
    ...
    default_workspace: str = "~/.cloud-dev-harness/workspace"
...
def _write_default_config():
    default = {
        ...
        "default_cloud": "tcb",
        "default_workspace": "~/.cloud-dev-harness/workspace",
        "providers": {
            "anthropic": {
        ...
        "clouds": {
            "tcb": {
                "region": "ap-shanghai",
                "env_id": "your-env-id",
                "credentials": "~/.tcb/credentials.json",
            }
        },
        "observability": {
            "trace_enabled": True,
            ...
            "trace_dir": "~/.cloud-dev-harness/traces",
        },
        "tui": {
            "theme": "auto",
