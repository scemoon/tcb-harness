...
def register_commands() -> None:
    platform_commands.register("model", "Set CDHA LLM model", _model, "<model name>")
    platform_commands.register("provider", "Set CDHA LLM provider", _provider, "<provider name>")
