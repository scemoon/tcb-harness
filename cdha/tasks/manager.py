...
logger = logging.getLogger("cdha.tasks")
...
class TaskManager:
    def __init__(self, storage_path: Optional[Path] = None):
        ...
        self._storage_path = storage_path or Path.home() / ".cdha" / "tasks"
    ...
    def add_todo_to_task(self, task_id: str, content: str, status: str = "pending") -> Optional["TaskChecklistItem"]:
        from cdha.tasks.models import TaskChecklistItem
    ...
    def add_timeline_entry(self, task_id: str, event: str, detail: str = "") -> bool:
        ...
        if not task:
            return False
        from cdha.tasks.models import TaskTimelineEntry
